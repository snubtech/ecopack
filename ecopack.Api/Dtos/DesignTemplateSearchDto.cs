/**
 * ==============================================================================
 * [프로그램 전체 흐름 및 구조 요약] - DesignTemplate 조회용 자료 묶음 (디자인 템플릿)
 * ==============================================================================
 * 
 * 1. 구성
 *    - DesignTemplate 조회용 자료 묶음 화면이 서버와 주고받는 자료입니다. 대상 테이블은 if002 / if002a 입니다.
 *    - 조회조건(Filters), 목록 한 행(Row), 목록+건수(Page) 로 나눠 담습니다.
 * 
 * 2. 알아둘 점
 *    - DesignTemplateDetailDto : 디자인설명내용·디자인 특징·제품의 설명과 이미지를 담습니다.
 *    - memoImg 는 HTML 이라 이미지 주소만 뽑아 MemoImageUris 에 담습니다(HTML 주입 방지).
 * ==============================================================================
 */
