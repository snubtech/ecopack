/**
 * ==============================================================================
 * [프로그램 전체 흐름 및 구조 요약] - PrimaryDocDto (적합성 선언서 주고받기용 자료 묶음)
 * ==============================================================================
 * 
 * 1. 쓰임새
 *    - 적합성 선언서 화면과 서버가 주고받는 항목을 담습니다. primary_doc 전체 컬럼과 1:1로 맞췄습니다.
 * 
 * 2. 타입을 모두 string? 으로 둔 이유
 *    - 화면의 입력 항목이 전부 글자이기 때문입니다. 빈 문자열은 null 로 저장됩니다.
 * 
 * 3. 함께 두는 자료
 *    - EvdDocUploadResultDto : 근거문서(부속서)를 올린 결과(슬롯 번호·파일명·경로)를 돌려줍니다.
 * ==============================================================================
 */
