/**
 * ==============================================================================
 * [프로그램 전체 흐름 및 구조 요약] - SecondaryTdDto (기술문서 주고받기용 자료 묶음)
 * ==============================================================================
 * 
 * 1. 쓰임새
 *    - 기술문서 화면과 서버가 주고받는 항목을 담습니다. secondary_td 전체 컬럼과 1:1로 맞췄습니다.
 * 
...
{
    /// <summary>
    /// 2차포장 기술문서(secondary_td / 모듈 A) 화면 CRUD DTO.
    ...
    /// </summary>
    public class SecondaryTdDto
    {
        // ── 키 ────────────────────────────────────────────────
        /// <summary>2차포장기술문서 ID. 신규 저장 시 서버에서 TD-2-{yyyyMMddHHmmssfff} 로 채번</summary>
    ...
    public class SecondaryAtchDocUploadResultDto
    {
