...
namespace ecopack.Api.Controllers
{
    ...
    public class TertiaryTdController : ControllerBase
    {
        ...
        // ─────────────────────────────────────────────────────────────
        // POST: api/TertiaryTd/UploadMfrDrw   (multipart/form-data)
        ...
        // ─────────────────────────────────────────────────────────────
        // DELETE: api/TertiaryTd/DeleteMfrDrw?prjId=xxx
        ...
        private static readonly HashSet<string> SkipOnWrite =
            new(StringComparer.Ordinal) { nameof(TertiaryTdDto.Pkg3TechDocId), nameof(TertiaryTdDto.LastWrtDtm), nameof(TertiaryTdDto.MfrDrwUrl),
        ...
        private static TertiaryTdDto ToDto(TertiaryTd entity, IWebHostEnvironment env)
        {
