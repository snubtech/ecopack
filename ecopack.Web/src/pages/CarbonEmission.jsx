/**
 * ==============================================================================
 * [프로그램 전체 흐름 및 구조 요약] - CarbonEmission 컴포넌트 (라이브러리 > 탄소배출량)
 * ==============================================================================
 * 
 * 1. 초기 데이터 로드 (useEffect)
 *    - 조회조건 셀렉트 3종(포장차수·적용소재·소재의 구성)을 받아온 뒤 전체 목록을 조회합니다.
 * 
 * 2. 조회 조건 관리 (condition / appliedRef)
 *    - 입력 중인 조건과 실제 조회에 쓰인 조건을 나눠, [조회] 를 눌러야 목록이 바뀌게 했습니다.
 * 
 * 3. 목록 조회 (fetchList)
 *    - if005(환경영향평가정보)에서 중량 당·단위당 탄소배출량과 물리적 인자를 받아옵니다.
 * 
 ...
 *    - 컬럼 제목이 길어 헤더를 여러 줄로 접고(lib-grid-wrapheader), 수치 컬럼은 오른쪽 정렬합니다.
 * ==============================================================================
 */
