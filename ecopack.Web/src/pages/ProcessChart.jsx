/**
 * ==============================================================================
 * [프로그램 전체 흐름 및 구조 요약] - ProcessChart 컴포넌트 (라이브러리 > 공정도)
 * ==============================================================================
 * 
 * 1. 초기 데이터 로드 (useEffect)
 *    - 조회조건 셀렉트(적용소재)를 받아온 뒤 전체 목록의 첫 페이지를 조회합니다.
 *    - 목록은 if003(공정도 목록)에서 가져오며, 무거운 이미지는 담기지 않습니다.
 * 
 * 2. 조회 조건 관리 (condition / appliedRef)
 *    - 입력 중인 조건과 실제 조회에 쓰인 조건을 나눠, [조회] 를 눌러야 목록이 바뀌게 했습니다.
 * 
 * 3. 공정도 이미지 펼치기 (handleToggleDetail)
 *    - 탬플릿명을 누르면 그 행 아래로 공정도 이미지를 펼칩니다.
 *    - 이미지는 용량이 크므로 펼칠 때 한 번만 서버(if003a)에서 받아오고,
 ...
 *    - 목록 행과 이미지 행이 번갈아 나오도록 각 행을 배열로 반환해 그립니다.
 * ==============================================================================
 */
