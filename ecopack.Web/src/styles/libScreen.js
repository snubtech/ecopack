/**
 * ==============================================================================
 * [프로그램 전체 흐름 및 구조 요약] - libScreen 스타일 (라이브러리 조회 화면 공용)
 * ==============================================================================
 * 
 * 1. 쓰임새
 *    - 라이브러리 조회 화면 5종이 같은 모양을 갖도록 모아 둔 스타일입니다.
 *    - 각 화면은 이 스타일을 가져다 쓰고, 화면마다 다른 부분만 따로 덧붙입니다.
 * 
 * 2. 화면 구조
 *    - 세로로 [툴바] - [조회조건] - [목록] - [페이징] 순서로 쌓입니다.
 *    - 3분할 레이아웃의 중간 패널 높이를 가득 채우고, 목록만 상하·좌우로 스크롤됩니다.
 *    - 목록의 컬럼 머리글은 위쪽에 고정되어 세로로 스크롤해도 계속 보입니다.
 * ==============================================================================
 */
/**
